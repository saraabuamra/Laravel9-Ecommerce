        ...
        @if (Auth::guard('admin')->user()->type == 'vendor')
            <li class="nav-item">
                <a @if (Session::get('page') == 'update-personal-details' ||
                        ...
                        Session::get('page') == 'update-bank-details') style="background-color:#4B49AC !important; 
            color:white !important;" @endif
                ...
                <div class="collapse" id="ui-vendors">
                    <ul class="nav flex-column sub-menu"
                        style="background-color: white !important; color:#4B49AC !important;">
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'update-personal-details') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/update-vendor-details/personal') }}">Personal
                                Details</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'update-business-details') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/update-vendor-details/business') }}">Business
                                Details</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'update-bank-details') style="background-color:#4B49AC !important; 
                                color:white !important;" @else style="background-color:white !important; 
                                color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/update-vendor-details/bank') }}">Bank
                                Details</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                <a @if (Session::get('page') == 'sections' ||
                        ...
                        Session::get('page') == 'filters') style="background-color:#4B49AC !important; 
             color:white !important;" @endif
                ...
                <div class="collapse" id="ui-catalogue">
                    <ul class="nav flex-column sub-menu"
                        style="background-color: white !important; color:#4B49AC !important;">
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'products') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
        ...
        @else
            ...
            color:white !important;" @endif
                ...
                <div class="collapse" id="ui-settings">
                    <ul class="nav flex-column sub-menu"
                        style="background-color: white !important; color:#4B49AC !important;">
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'update-admin-password') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ route('update-admin-password') }}">Update Password</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'update-admin-details') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
            ...
            <li class="nav-item">
                <a @if (Session::get('page') == 'view_admins' ||
                        ...
                        Session::get('page') == 'view_all') style="background-color:#4B49AC !important; 
            color:white !important;" @endif
                ...
                <div class="collapse" id="ui-admins">
                    <ul class="nav flex-column sub-menu"
                        style="background-color: white !important; color:#4B49AC !important;">
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'view_admins') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/admins/admin') }}">Admins</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'view_subadmins') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/admins/subadmin') }}">Subadmins</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'view_vendors') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/admins/vendor') }}">Vendors</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'view_all') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
            ...
            <li class="nav-item">
                <a @if (Session::get('page') == 'sections' ||
                        ...
                        Session::get('page') == 'coupons') style="background-color:#4B49AC !important; 
             color:white !important;" @endif
                    class="nav-link" data-toggle="collapse" href="#ui-catalogue" aria-expanded="false"
                    aria-controls="ui-catalogue">
                    <i class="icon-layout menu-icon"></i>
                ...
                <div class="collapse" id="ui-catalogue">
                    <ul class="nav flex-column sub-menu"
                        style="background-color: white !important; color:#4B49AC !important;">
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'sections') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/sections') }}">Sections</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'categories') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/categories') }}">Categories</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'brands') style="background-color:#4B49AC !important; 
                                color:white !important;" @else style="background-color:white !important; 
                                color:#4B49AC !important;" @endif
                        ...
                        color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/products') }}">Products</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'coupons') style="background-color:#4B49AC !important; 
                                color:white !important;" @else style="background-color:white !important; 
                                color:#4B49AC !important;" @endif
                                class="nav-link" href="{{ url('admin/coupons') }}">Coupons</a></li>
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'filters') style="background-color:#4B49AC !important; 
                                color:white !important;" @else style="background-color:white !important; 
                                color:#4B49AC !important;" @endif
            ...
            color:white !important;" @endif
                ...
                <div class="collapse" id="ui-banners">
                    <ul class="nav flex-column sub-menu"
                        style="background-color: white !important; color:#4B49AC !important;">
                        <li class="nav-item"> <a
                                @if (Session::get('page') == 'banners') style="background-color:#4B49AC !important; 
                        color:white !important;" @else style="background-color:white !important; 
                        color:#4B49AC !important;" @endif
