        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <a style="background-color: #4B49AC;border-color: #4B49AC; float: right; width:150px" class="btn btn-primary" href="{{url('admin/add-edit-brand')}}">Add Brand</a>
                      ...
                      <td>
                       <a href="{{url('admin/add-edit-brand/'.$brand['id'])}}">
                        ...
                        class="mdi mdi-pencil-box"></i> </a>
                            <a href="javascript:void(0)" module="brand" class="confirmDelete" moduleid="{{$brand['id']}}">
                                <i style="font-size: 25px ;color:#4B49AC;" 
