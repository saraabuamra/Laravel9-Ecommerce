        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="login-wrapper">
                    ...
                    <h6 class="account-h6 u-s-m-b-30">Welcome back! Forgot Password? </h6>
                    <p id="forgot-error"></p>
                    ...
                    <form id="forgotForm" action="javascript:;" method="POST">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            class="text-field" placeholder="Email">
                            <p id="forgot-email"></p>
                        </div>
                ...
                <div class="reg-wrapper">
                    ...
                    <form id="registerForm" action="javascript:;" method="post">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            class="text-field" placeholder="User Name">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            class="text-field" placeholder="User Mobile">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="text" id="user-email" name="email"
                             class="text-field" placeholder="User Email">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="password" id="user-password" name="password"
                             class="text-field" placeholder="User Password">
