            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                @endif
                    ...
                    @if (isset($productDetails['vendor']))
                        <div><a href="/products/{{$productDetails['vendor']['id']}}">
                        Sold by {{$productDetails['vendor']['vendorbusinessdetails']['shop_name']}}</a></div>
                    @endif
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active show" id="video">
                            <div class="description-whole-container">
                                ...
                                <video controls>
                                <source src="{{url('front/videos/product_videos/'
                                .$productDetails['product_video'])}}" type="video/mp4">
                                </video>
                                @else
                                    ...
                                    <table>
                                        ...
                                        <?php
                                         $filterAvailable = ProductsFilter::filterAvailable(
                                            $filter['id'],$productDetails['category_id']);
                                          ?>
