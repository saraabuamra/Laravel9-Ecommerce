                ...
                <div class="reg-wrapper">
                    ...
                    <form id="vendorForm" action="{{url('/vendor/register')}}" method="post">
                        ...
                        <div class="u-s-m-b-30">
                            ...
                            <input type="text" id="vendorname" name="name" 
                            class="text-field" placeholder="Vendor Name">
                        </div>
                        <div class="u-s-m-b-30">
                            <label for="vendormobile">Mobile
                                <span class="astk">*</span>
                            </label>
                            <input type="text" id="vendormobile" name="mobile" 
                            class="text-field" placeholder="Vendor Mobile">
                        </div>
                        <div class="u-s-m-b-30">
                            <label for="vendoremail">Email
                                <span class="astk">*</span>
                            </label>
                            <input type="text" id="vendoremail" name="email"
                             class="text-field" placeholder="Vendor Email">
                        </div>
                        <div class="u-s-m-b-30">
                            <label for="vendorpassword">Password
                                <span class="astk">*</span>
                            </label>
                            <input type="password" id="vendorpassword" name="password"
                             class="text-field" placeholder="Vendor Password">
                        </div>
                        <div class="u-s-m-b-30">
                            <input type="checkbox" class="check-box" name="accept"
                             id="accept">
